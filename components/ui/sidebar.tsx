  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className={cn(
              "w-(--sidebar-width) transition-(--sidebar-width) duration-700 ease-linear bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden",
              openMobile && "animate-slide-in-left",
            )}
            style={
              {
    ...
    return (
      <div
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:hidden",
            side === "left"
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}>
      <PanelLeft className="size-6 md:size-8" />
